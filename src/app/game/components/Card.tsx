    ...
    >
      <div className="w-full h-full bg-white border border-[#f63f3f7c] rounded-lg p-3 grid grid-rows-[1fr_1fr_auto]">
        ...
        <div className="w-full text-black text-start">
          <p className="py-2 px-4 shadow-md no-underline text-center rounded-full bg-[var(--secondary-color)] text-white font-sans font-semibold text-sm border-orange btn-primary hover:text-white hover:bg-orange-light focus:outline-none active:shadow-none mr-2">
            <span className="animate-pulse text-center">{`#${card.id}`}</span>
          </p>
        </div>
      </div>
    </div>
